...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">地址信息</strong></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
            <tr>
              <th>ID</th><th>地址id</th><th>地址</th><th>操作</th>
            </tr>
          </thead>
            <tbody>
            <tr>
      <?php if(is_array($address)): foreach($address as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
              ...
              <div class="am-dropdown" data-am-dropdown>
                 ...
                 <ul class="am-dropdown-content">
                    <li>
                       <a href="<?php echo U('/Home/User/addtoupdata', array('id' => $v['id']));?>">1. 修改地址</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/User/addressupdata', array('addressid' => $v['addressid']));?>">2. 添加地址</a>
                    </li>
                      <li>
                       <a href="<?php echo U('/Home/User/addressgotrach', array('id' => $v['id']));?>">4. 删除地址</a>
                    </li>
                 </ul>
              </div>
              </td>
