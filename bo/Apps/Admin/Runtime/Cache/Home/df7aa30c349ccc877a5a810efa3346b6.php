...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">广告信息</strong></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
            <tr>
              <th>ID</th><th>广告URL</th><th>操作</th>
            </tr>
          </thead>
            <tbody>
            <tr>
      <?php if(is_array($billing)): foreach($billing as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
              ...
              <div class="am-dropdown" data-am-dropdown>
                 ...
                 <ul class="am-dropdown-content">
                    <li>
                       <a href="<?php echo U('/Home/Billing/gotrach', array('id' => $v['id']));?>">1. 删除</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/Billing/addbilling');?>">2. 添加</a>
                    </li>
                 </ul>
              </div>
              </td>
