...
<!-- content start -->
 <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改地址</strong></div>
    </div>
    <hr/>
    <form class="am-form" action="<?php echo U('/Home/User/addtodata');?>"  method='post' enctype="multipart/form-data">
    <div class="am-g">
        <div class="am-panel am-panel-default">
          <div class="am-panel-bd">
            <?php if(is_array($address)): foreach($address as $key=>$v): ?><td align='right' >ID&nbsp;:&nbsp;</td>
            <td><input type="text" name='id' value='<?php echo ($v["id"]); ?>'/></td>
            <td align='right' >地址id&nbsp;:&nbsp;</td>
            <td><input type="text" name='addressid' value='<?php echo ($v["addressid"]); ?>'/></td>
            <td align='right' >地址&nbsp;:&nbsp;</td>
            <td><input type="text" name='address' value='<?php echo ($v["address"]); ?>'/></td><?php endforeach; endif; ?>
