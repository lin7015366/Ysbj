...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">订单信息(未处理)</strong></div>
    </div>
    ...
    <div class="am-g">
      ...
      <?php if(is_array($order)): foreach($order as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
              ...
              <div class="am-dropdown" data-am-dropdown>
                 ...
                 <ul class="am-dropdown-content">
<!--                     <li>
                       <a href="<?php echo U('/Home/Order/toiorder', array('id' => $v['id']));?>">1. 转入处理中</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/Order/tosorder', array('id' => $v['id']));?>">2. 完成</a>
                    </li> -->
                    <li>
