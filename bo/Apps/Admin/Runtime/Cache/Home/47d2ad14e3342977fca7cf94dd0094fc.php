...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">订单信息(处理中)</strong></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
            <tr>
              <th>ID</th><th>订单id</th><th>tel</th><th>发货时间</th><th>操作</th>
            </tr>
          </thead>
            <tbody>
            <tr>
      <?php if(is_array($order)): foreach($order as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
              ...
              <td><?php echo (date('Y-m-d H:i:s',$v["itime"])); ?></td>
              <td>
   ...
   <!--                  <li>
                    ...
                    <li>
                       <a href="<?php echo U('/Home/Order/tosorder', array('id' => $v['id']));?>">1. 完成</a>
                    </li>
                 </ul>
              </div>
              </td>
