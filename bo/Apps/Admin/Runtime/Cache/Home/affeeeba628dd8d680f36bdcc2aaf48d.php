    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
            <tr>
              <th>订单id</th><th>产品名</th><th>单价</th><th>数量</th><th>操作</th>
            </tr>
          </thead>
            <tbody>
            <tr>
      <?php if(is_array($ordermx)): foreach($ordermx as $key=>$v): ?><td><?php echo ($v["orderid"]); ?></td>
...
<!--                     <li>
                    ...
                    <li>
                       <a href="<?php echo U('/Home/Order/tosorder', array('orderid' => $v['orderid']));?>">1. 完成</a>
                    </li> 
                    <li>
                       <a href="<?php echo U('/Home/Order/delorder', array('orderid' => $v['orderid']));?>">2. 删除</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/Order/alldelorder', array('orderid' => $v['orderid']));?>">3. 全部删除</a>
                    </li>
                 </ul>
              </div>
              </td>
