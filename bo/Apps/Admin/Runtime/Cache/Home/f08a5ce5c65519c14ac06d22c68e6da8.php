...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">产品信息</strong></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
            <tr>
              <th>ID</th><th>产品名</th><th>原价</th><th>现价</th><th>说明</th><th>操作</th>
            </tr>
          </thead>
            <tbody>
            <tr>
      <?php if(is_array($bot)): foreach($bot as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
              ...
              <div class="am-dropdown" data-am-dropdown>
                 ...
                 <ul class="am-dropdown-content">
                    <li>
                       <a href="<?php echo U('/Home/Bot/updata', array('id' => $v['id']));?>">1. 编辑</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/Bot/totrach', array('id' => $v['id']));?>">2. 删除</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/Bot/addbot');?>">3. 添加</a>
                    </li>
                 </ul>
              </div>
              </td>
