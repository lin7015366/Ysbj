...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>数据</small></div>
    </div>

    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="<?php echo U('/Home/Weibo/index');?>" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>num<br/><?php echo ($num); ?></a></li>
      <li><a href="<?php echo U('/Home/Weibo/trach');?>" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>num<br/><?php echo ($num1); ?></a></li>
      <li><a href="<?php echo U('/Home/User/trach');?>" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>num<br/><?php echo ($num2); ?></a></li>
      <li><a href="#" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>num<br/><?php echo ($num); ?></a></li>
    </ul>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          ...
          <tbody>
          <tr>
      <?php if(is_array($list)): foreach($list as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
