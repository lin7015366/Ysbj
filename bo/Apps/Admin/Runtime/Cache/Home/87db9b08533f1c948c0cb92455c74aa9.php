...
<!-- content start -->
 <div class="admin-content">
    ...
    <hr/>
    <form class="am-form" action="<?php echo U('/Home/User/saveuser');?>"  method='post' enctype="multipart/form-data">
    <div class="am-g">
        <div class="am-panel am-panel-default">
          <div class="am-panel-bd">
            <?php if(is_array($user)): foreach($user as $key=>$v): ?><td align='right' >ID&nbsp;:&nbsp;</td>
            ...
            <td><input type="text" name='tel' value='<?php echo ($v["tel"]); ?>'/></td><?php endforeach; endif; ?>
