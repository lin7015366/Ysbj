    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
            <tr>
              <th>ID</th><th>用户id</th><th>姓名</th><th>手机</th><th>积分</th><th>地址id</th><th>操作</th>
            </tr>
          </thead>
            <tbody>
            <tr>
      <?php if(is_array($user)): foreach($user as $key=>$v): ?><td><?php echo ($v["id"]); ?></td>
              ...
              <div class="am-dropdown" data-am-dropdown>
                 ...
                 <ul class="am-dropdown-content">
                    <li>
                       <a href="<?php echo U('/Home/User/updata', array('id' => $v['id']));?>">1. 修改用户</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/User/addupdata', array('addressid' => $v['addressid']));?>">2. 查看用户地址</a>
                    </li>
                      <li>
                       <a href="<?php echo U('/Home/User/gotrach', array('id' => $v['id']));?>">4. 删除</a>
                    </li>
                    <li>
                       <a href="<?php echo U('/Home/User/adduser');?>">3. 添加</a>
                    </li>
                 </ul>
              </div>
              </td>
