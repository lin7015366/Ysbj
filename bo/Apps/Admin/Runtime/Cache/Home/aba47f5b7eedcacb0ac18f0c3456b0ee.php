    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <ul class="am-list am-User admin-sidebar-sub am-in" id="User-nav">
         <li><a href="<?php echo U('/Home/User');?>" class="am-cf"><span class="am-icon-check"></span>用户信息<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
          ...
          <li><a href="<?php echo U('/Home/User/adduser');?>" class="am-cf"><span class="am-icon-check"></span> 地址<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
        </ul></li>
        ...
        <ul class="am-list am-Order admin-sidebar-sub am-in" id="Order-nav">
         <li><a href="<?php echo U('/Home/Order');?>" class="am-cf"><span class="am-icon-check"></span> 订单信息(未处理)<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
...
<!-- content start -->
 <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">地址添加</strong></div>
    </div>
    <hr/>
    <form class="am-form" action="<?php echo U('/Home/User/addtoadd');?>"  method='post' enctype="multipart/form-data">
    <div class="am-g">
        <div class="am-panel am-panel-default">
          <div class="am-panel-bd">
            <?php if(is_array($address)): foreach($address as $key=>$v): ?><td align='right' >地址id&nbsp;:&nbsp;</td>
            <td><input type="text" name='addressid' value='<?php echo ($v["addressid"]); ?>'/></td>
            <td align='right' >地址&nbsp;:&nbsp;</td>
            <td><input type="text" name='address'/></td><?php endforeach; endif; ?>
