  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="<?php echo U('/Home/User/trach');?>" class="am-cf"><span class="am-icon-check"></span> 回车站<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
        </ul></li>
...
<!-- content start -->
 <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">产品添加</strong></div>
    </div>
    <hr/>
    <form class="am-form" action="<?php echo U('/Home/Bot/addtobot');?>"  method='post' enctype="multipart/form-data">
    <div class="am-g">
