...
<!-- content start -->
 <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改产品</strong></div>
    </div>
    <hr/>
    <form class="am-form" action="<?php echo U('/Home/Bot/savebot');?>"  method='post' enctype="multipart/form-data">
    <div class="am-g">
        <div class="am-panel am-panel-default">
          <div class="am-panel-bd">
            <?php if(is_array($bot)): foreach($bot as $key=>$v): ?><td align='right' >ID&nbsp;:&nbsp;</td>
            ...
            <td><input type="text" name='price' value='<?php echo ($v["price"]); ?>'/></td>
            <td align='right' >现价&nbsp;:&nbsp;</td>
            <td><input type="text" name='newprice' value='<?php echo ($v["newprice"]); ?>'/></td>
            <td align='right' >说明&nbsp;:&nbsp;</td>
            <td><input type="text" name='content' value='<?php echo ($v["content"]); ?>'/></td>
